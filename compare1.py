...
def finish(kills, losses, x_algorithm_use_rate):
    ...
    MI.PAUSE = 0.001
    # button_images = [f'images/xButton/xbutton{i}.png' for i in range(1, 67)]
    ...
    for e, button_image_path in enumerate(button_images, start=1):
        ...
        x = MI.locateCenterOnScreen(button_image_path, confidence=0.85, grayscale=True, region=(400, 165, 400, 270))
        if x:
            MI.click(x)
        ...
        if MI.locateCenterOnScreen('images/med_playerbubble.png', confidence = 0.70):
            print("\n\tCorrect X button: {},60".format(e))
            return kills, losses,  x_algorithm_use_rate
